...
const KNOWN_OFFICIAL_HASHES = Object.freeze({
  "rules/detect.md": new Set([
    ...
    "627d1bf950f9f87e655d5dd10215d408a2e605582e5e869f3b9b6cf67111ec49", // 0.2.5
  ]),
  "rules/workflow.md": new Set([
    ...
    "dd898983dc349d0c327e42f98f5d301bb3e08111acfdbe54624b720bdc54aba3", // 0.2.5
  ]),
  "skill/SKILL.md": new Set([
    ...
    "cdd550d32d66e4c5695413e8d11ab3c0fe5eab5a853f01017b3d03d186599cf8", // 0.2.5
  ]),
